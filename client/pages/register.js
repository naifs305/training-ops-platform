    ...
    <div className="min-h-screen bg-background">
      <div className="flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid w-full max-w-6xl overflow-hidden rounded-[28px] border border-border bg-white shadow-[0_20px_60px_rgba(0,0,0,0.08)] lg:grid-cols-2">
          <div className="hidden lg:flex flex-col justify-between bg-primary px-10 py-12 text-white">
          ...
          <div className="flex items-center justify-center bg-background px-6 py-10 sm:px-10">
            <div className="w-full max-w-2xl">
              <div className="mb-8 text-center lg:hidden">
                <div className="relative mx-auto mb-4 h-20 w-20 overflow-hidden rounded-2xl border border-border bg-white shadow-soft">
                  <Image
                    src="https://nauss.edu.sa/Style%20Library/ar-sa/Styles/images/home/Logo.svg"
                    alt="شعار جامعة نايف"
                    fill
              ...
              <div className="mb-8 text-right">
                <h3 className="text-3xl font-extrabold text-text-main">تسجيل حساب جديد</h3>
                <p className="mt-2 text-sm text-text-soft">
